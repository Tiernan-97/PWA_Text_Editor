...
A text editor which works both online and offline which saves your text into a database within your browser which can be recovered everytime you open the app. You can also
install the app onto your device!

## Methodoloy

I started my installing all of the necesseary packages into eacch of the package.json files. Following this, Is et up the scripts to allow you to build the PWA and run a
